...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdielec-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9708&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdielec-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdielec` can be installed with:

```
conda install pdielec
```

It is possible to list all of the versions of `pdielec` available on your platform with:
